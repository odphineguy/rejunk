...
values
  ...
  ('northwest-regional-landfill', 'Northwest Regional Landfill', 'landfill', '19401 W Deer Valley Rd', 'Surprise', 'AZ', '85387', '800-963-4776', 'https://www.wmsolutions.com/', 33.6819, -112.4874,
   '{household_junk,furniture,mixed_c_and_d,green_waste,dirt,rock,cardboard,metal}', '{hazardous_excluded,tires,appliances}', 'per_ton', 44, 40, 0, 0, 0,
   '{"Mon-Fri: 6:00 AM - 4:00 PM","Sat: 6:00 AM - 1:00 PM","Sun: Closed"}', 'WM regional landfill in the far NW Valley (Surprise). Takes MSW, C&D, yard waste, dirt/soil, and special waste; the adjacent ACE material-recovery facility handles cardboard and scrap-metal recycling. No tires and no Freon/refrigerant appliances. Confirm current gate rates before dispatch.', 'Northwest Valley (Surprise/Sun City/Wittmann) household junk, C&D, and heavy dirt/rock loads.', 'Lower per-ton disposal cost', '2026-06-09', false, true)
on conflict (id) do nothing;
