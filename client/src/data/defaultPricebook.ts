...
const GROUPS: SeedGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "moving-packing-materials", name: "Packing Materials (flat, per job)", price: 0, priceNote: "Flat, owner sets", itemType: "Product", notes: "Boxes + paper + tape as one amount — owner sets per job." },
    ],
  },
  {
    category: {
