...
const GROUPS: SeedGroup[] = [
  ...
  // ───────────────────────── Mode 2 — Moving & Delivery ─────────────────────────
  {
    ...
    items: [
      ...
      { id: "moving-home-medium", name: "Home Move — Medium House (3BR)", price: 1100, marginDecimal: 0.52, crewSize: 2, notes: "Box truck required. 6-8 hrs typical." },
      { id: "moving-home-large", name: "Home Move — Large House (4BR)", price: 1500, marginDecimal: 0.53, crewSize: 3, notes: "Box truck required. 8-10 hrs typical. 3 workers for safety. Photos required." },
      { id: "moving-home-xlarge", name: "Home Move — X-Large House (5BR+)", price: 2500, marginDecimal: 0.55, crewSize: 3, notes: "Box truck required. Custom scope — photos and walkthrough required." },
