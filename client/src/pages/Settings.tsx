...
function SettingsTile({ card }: { card: SettingsCard }) {
  ...
  const className =
    "group flex min-h-[98px] items-center gap-4 rounded-lg border border-border bg-card px-6 py-5 text-left shadow-sm transition-colors hover:border-[#3f3df1]/40 hover:bg-muted/20";
