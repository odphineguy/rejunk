  ...
  return (
    <PageShell title="Terms of Service" updated="June 16, 2026">
      ...
      <section className={sectionClass} style={{ borderColor: P.line }}>
        ...
        <p className="mt-3">
          We provide junk removal, local moving, delivery, furniture assembly,
          cleanout, and related services across the {SERVICE_AREA}. Quotes are
          based on the information you provide and may be updated if the job
          scope, access conditions, stairs, item count, item weight, or disposal
          requirements change.
        </p>
      </section>
      ...
      <section className={sectionClass} style={{ borderColor: P.line }}>
        ...
        <p className="mt-3">
          We aim to provide clear pricing before work begins. A scheduled
          appointment is not confirmed until we accept the job and provide a
          service window. Payment is due when the service is completed unless we
      ...
      <section className={sectionClass} style={{ borderColor: P.line }}>
        ...
        <p className="mt-3">
          ...
          opt out. Reply HELP for help, or contact us at{" "}
          <a
            href={PHONE_HREF}
      ...
      <section className={sectionClass} style={{ borderColor: P.line }}>
        ...
        <p className="mt-3">
          You are responsible for providing accurate job details, safe access to
          the work area, parking or loading access when needed, and notice of
          any hazardous, unusually heavy, or restricted materials before the
          crew arrives.
        </p>
      </section>
